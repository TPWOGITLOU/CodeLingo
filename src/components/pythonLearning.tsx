const PythonVariablesContent = (
    <>
      ...
      <p className='text-left indent-8 text-sm'>
  ...
  const PythonPrimitivesContent = (
    <>
      ...
      <p className='indent-8 text-left text-sm mb-2'>
      ...
      <ul className='text-left text-sm list-disc list-inside mb-2'>
        <li>
        ...
        <li>
          After the equals sign, you put whatever you want to save in your variable. It could be a number, a word, or even a sentence! For example, if you have a toy robot and you want to give it the name &apos;my_robot&apos;, you can do it like this: <code className="bg-slate-200 dark:bg-slate-600 rounded-sm p-0.5"><span className="text-black dark:text-white">my_robot</span> = <span className="text-orange-700 dark:text-orange-400">&apos;Robot Toy&apos;</span></code>
        </li>
      </ul>
      ...
      <p className='indent-8 text-left text-sm'>
  ...
  const PythonPrintContent = (
    <>
      ...
      <p className='text-left indent-8 text-sm'>
        The syntax of the print function is straightforward. You start with the keyword print, followed by brackets (). Inside the brackets, you put whatever you want to display, whether it&apos;s text (enclosed in quotes), numbers, variables, or even mathematical expressions. You can print out any text by enclosing it in single quotes &apos; &apos; or double quotes &apos;&apos; &apos;&apos;. For example: <code className="bg-slate-200 dark:bg-slate-600 rounded-sm p-0.5"><span className="text-blue-700 dark:text-blue-500">print</span><span className="text-blue-700 dark:text-yellow-400">(</span><span className="text-orange-700 dark:text-orange-400">&apos;Hello, world!&apos;</span><span className="text-blue-700 dark:text-yellow-400">)</span></code> or <code className="bg-slate-200 dark:bg-slate-600 rounded-sm p-0.5"><span className="text-blue-700 dark:text-blue-500">print</span><span className="text-blue-700 dark:text-yellow-400">(</span><span className="text-orange-700 dark:text-orange-400">&apos;Python is Awesome!&apos;</span><span className="text-blue-700 dark:text-yellow-400">)</span></code>
      </p>
  
      <h2 className='text-center font-bold underline text-l'>Variables</h2>
  
      <p className='text-left indent-8 text-sm'>
        You can also print the value stored in a variable by passing the variable name inside the print function. For example: <code className="bg-slate-200 dark:bg-slate-600 rounded-sm p-0.5"><span className="text-black dark:text-white">name = </span> <span className="text-orange-700 dark:text-orange-400">&apos;Alice&apos; </span> <span className="text-blue-700 dark:text-blue-500">print</span><span className="text-blue-700 dark:text-yellow-400">(</span><span className="text-orange-700 dark:text-orange-400">&apos;Hello, &apos;</span><span className="text-black dark:text-white">name</span><span className="text-blue-700 dark:text-yellow-400">)</span></code>
      </p>
  
      <h2 className='text-center font-bold underline text-l'>Concatenation</h2>
  
      <p className='text-left indent-8 text-sm'>
        If you want to combine text and variables in the same print statement, you can use commas to separate them. Python automatically adds spaces between the items. For example: <code className="bg-slate-200 dark:bg-slate-600 rounded-sm p-0.5"><span className="text-black dark:text-white">age = </span> <span className="text-emerald-600 dark:text-emerald-300">10</span> <span className="text-blue-700 dark:text-blue-500">print</span><span className="text-blue-700 dark:text-yellow-400">(</span><span className="text-orange-700 dark:text-orange-400">&apos;My age is &apos;</span><span className="text-black dark:text-white">age</span><span className="text-blue-700 dark:text-yellow-400">)</span></code>
      </p>
    </>
  );
  //
